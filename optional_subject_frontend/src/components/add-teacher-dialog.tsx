...
// Estado inicial del formulario basado en el modelo Teacher
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(`Error al crear el profesor (${response.status})`)
      }
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <DialogDescription className="text-blue-200 text-xs">
                  Completa los campos para registrar un nuevo profesor.
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>
