...
// Estado inicial del formulario basado en el modelo Student
...
// Opciones para facultad (ajusta según tu backend)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(`Error al crear el estudiante (${response.status})`);
      }
