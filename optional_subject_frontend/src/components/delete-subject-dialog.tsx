...
export function DeleteSubjectDialog({ open, onOpenChange, subject, onSuccess }: DeleteSubjectDialogProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(`Error al eliminar la asignatura (${response.status})`)
      }
        ...
        <div className="p-6">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-gray-400 mt-2">
              Se eliminarán todos los datos asociados a esta asignatura.
            </p>
          </div>
